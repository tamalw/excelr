...
excelr is a plugin to generate Microsoft Excel documents with Rails. This plugin
...
Run the following command in your RAILS_ROOT:
  ...
  ./script/plugin install git://github.com/xinuc/excelr.git

Or, simply get the tarball at:

  http://github.com/xinuc/excelr/tarball/master

extract it to your vendor/plugins and rename it to 'excelr'
...
excelr will use .excelr files as the template. So, with the example above,
we will need to create 'index.xls.excelr' in app/views/products/.
